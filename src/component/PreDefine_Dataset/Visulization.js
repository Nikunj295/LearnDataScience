    ...
    <div className={classes.root}>
      <AppBar position="static">
        ...
        >
          ...
          <LinkTab label="HeatMap"  {...a11yProps(1)} />
          <LinkTab label="PieChart"  {...a11yProps(2)} />
          <LinkTab label="ScatterPlot"  {...a11yProps(3)} />
        </Tabs>
      </AppBar>
      <TabPanel value={value} index={0}>
        {
            result? <> <AxisSelect2 values={final}/>  <Lines values={final}/> </> :null
        }
      </TabPanel>
